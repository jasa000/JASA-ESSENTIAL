...
// Add a new shop
export const addShop = async (data: Omit<Shop, 'id' | 'createdAt'>): Promise<string> => {
  try {
...
// Update a shop
export const updateShop = async (id: string, data: Partial<Omit<Shop, 'id' | 'createdAt'>>): Promise<void> => {
  try {
