...
import type { UserProfile, UserRole, UserLocation } from '@/lib/types';
      ...
      if (firebaseUser) {
        ...
        const unsubscribeSnapshot = onSnapshot(userDocRef, async (docSnap) => {
          if (docSnap.exists()) {
            ...
            // 4. Migrate from selectedPincode to userLocation
            if (userProfile.selectedPincode !== undefined) {
              ...
              needsUpdate = true;
              userProfile.userLocation = updates.userLocation;
              delete userProfile.selectedPincode;
            } else if (userProfile.userLocation === undefined) {
               updates.userLocation = null;
               needsUpdate = true;
               userProfile.userLocation = null;
            }

            
            // 5. If any migration happened, update the DB
            if (needsUpdate) {
              try {
